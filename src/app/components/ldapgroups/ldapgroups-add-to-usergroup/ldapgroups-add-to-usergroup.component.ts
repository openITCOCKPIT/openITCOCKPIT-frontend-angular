...
@Component({
    selector: 'oitc-ldapgroups-add-to-usergroup-modal',
    imports: [
        ButtonCloseDirective,
        XsButtonDirective,
        FaIconComponent,
    ...
    templateUrl: './ldapgroups-add-to-usergroup.component.html',
    styleUrl: './ldapgroups-add-to-usergroup.component.css',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class LdapgroupsAddToUsergroupComponent implements OnChanges {
