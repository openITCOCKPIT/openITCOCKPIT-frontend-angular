...
import { SymantecMailGatewayWizardService } from './symantec-mail-gateway-wizard.service';
...
@Component({
    selector: 'oitc-symantec-mail-gateway',
    imports: [
        RouterLink,
        FaIconComponent,
        CardComponent,
    ...
    templateUrl: './symantec-mail-gateway.component.html',
    styleUrl: './symantec-mail-gateway.component.css',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class SymantecMailGatewayComponent extends WizardsAbstractComponent {
    @ViewChild(WizardsDynamicfieldsComponent) childComponentLocal!: WizardsDynamicfieldsComponent;
    protected override WizardService: SymantecMailGatewayWizardService = inject(SymantecMailGatewayWizardService);
