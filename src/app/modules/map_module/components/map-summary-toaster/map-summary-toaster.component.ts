...
import {
    MapSummaryRoot,
    Summary,
} from '../../pages/mapeditors/mapeditors.interface';
...
export class MapSummaryToasterComponent implements OnDestroy {
    ...
    private readonly MapSummaryToasterService: MapSummaryToasterService =
        inject(MapSummaryToasterService);
            ...
            this.MapSummaryToasterService.itemObservable$.subscribe(
                ({ item, summary }) => {
                    ...
                    if (item) {
                        ...
                        this.subscriptions.add(
                            this.MapSummaryToasterService.getMapsummary(
                                item,
                                summary,
                            ).subscribe((data: MapSummaryRoot) => {
