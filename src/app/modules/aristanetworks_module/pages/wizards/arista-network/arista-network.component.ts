...
import { AristaNetworkWizardService } from './arista-network-wizard.service';
...
@Component({
    ...
    templateUrl: './arista-network.component.html',
    styleUrl: './arista-network.component.css',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class AristaNetworkComponent extends WizardsAbstractComponent {
    @ViewChild(WizardsDynamicfieldsComponent) childComponentLocal!: WizardsDynamicfieldsComponent;
    protected override WizardService: AristaNetworkWizardService = inject(AristaNetworkWizardService);
