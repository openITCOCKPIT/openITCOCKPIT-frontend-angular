...
import { SonicWallWizardService } from "./sonic-wall-wizard.service";
...
@Component({
    ...
    templateUrl: "./sonic-wall.component.html",
    styleUrl: "./sonic-wall.component.css",
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SonicWallComponent extends WizardsAbstractComponent {
    @ViewChild(WizardsDynamicfieldsComponent) childComponentLocal!: WizardsDynamicfieldsComponent;
    protected override WizardService: SonicWallWizardService = inject(SonicWallWizardService);
