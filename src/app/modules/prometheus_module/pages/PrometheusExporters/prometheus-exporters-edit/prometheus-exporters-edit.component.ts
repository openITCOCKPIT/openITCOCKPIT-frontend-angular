...
export class PrometheusExportersEditComponent implements OnInit, OnDestroy {
    ...
    private loadContainers(): void {
        this.subscriptions.add(
            this.PrometheusExportersService.loadContainers().subscribe((result: SelectKeyValue[]) => {
    ...
    private loadPrometheusExportersEdit(): void {
        ...
        this.subscriptions.add(
            this.PrometheusExportersService.getEdit(id).subscribe((result: PrometheusExporterEditRoot) => {
    ...
    public update(): void {
        this.subscriptions.add(
            this.PrometheusExportersService.update(this.post).subscribe((result: GenericResponseWrapper) => {
                this.cdr.markForCheck();
                if (result.success) {
