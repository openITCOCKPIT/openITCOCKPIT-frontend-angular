...
export class PrometheusExportersEditComponent implements OnInit, OnDestroy {
    ...
    private readonly PrometheusExportersService: PrometheusExportersService =
        inject(PrometheusExportersService);
    ...
    protected post: PrometheusExporterEditPost =
        {} as PrometheusExporterEditPost;
    ...
    private loadContainers(): void {
        this.subscriptions.add(
            this.PrometheusExportersService.loadContainers().subscribe(
    ...
    private loadPrometheusExportersEdit(): void {
        ...
        this.subscriptions.add(
            this.PrometheusExportersService.getEdit(id).subscribe(
                (result: PrometheusExporterEditRoot) => {
    ...
    public update(): void {
        this.subscriptions.add(
            this.PrometheusExportersService.update(this.post).subscribe(
                (result: GenericResponseWrapper) => {
                    ...
                    if (result.success) {
                        ...
                        this.HistoryService.navigateWithFallback([
                            '/prometheus_module/PrometheusExporters/index',
                        ]);
                        return;
                    }
                    // Error
