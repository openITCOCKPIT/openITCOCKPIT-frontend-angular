...
export class ApacheHttpWizardService extends WizardsService {
    ...
    public fetch(hostId: number): Observable<WizardGet> {
        return this.http.get<WizardGet>(`${this.proxyPath}/apache_module/wizards/apache_http/${hostId}.json?angular=true`).pipe(
    ...
    public submit(post: WizardPost): Observable<GenericResponseWrapper> {
