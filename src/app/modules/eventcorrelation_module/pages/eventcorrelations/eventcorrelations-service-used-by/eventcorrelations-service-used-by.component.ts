...
@Component({
    selector: 'oitc-eventcorrelations-service-used-by',
    imports: [
        AsyncPipe,
        BackButtonDirective,
        CardBodyComponent,
    ...
    templateUrl: './eventcorrelations-service-used-by.component.html',
    styleUrl: './eventcorrelations-service-used-by.component.css',
    providers: [
...
export class EventcorrelationsServiceUsedByComponent implements OnInit, OnDestroy {
    ...
    public load(): void {
        if (this.id > 0) {
            this.subscriptions.add(this.EventcorrelationsService.serviceUsedBy(this.id)
                .subscribe((result) => {
