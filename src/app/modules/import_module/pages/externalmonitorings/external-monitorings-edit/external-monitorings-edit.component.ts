...
export class ExternalMonitoringsEditComponent implements OnInit, OnDestroy {
    ...
    public loadConfigFieldsBySystemType() {
        if (this.post.system_type) {
            this.subscriptions.add(
                this.ExternalMonitoringsService.loadConfig(this.post.system_type).subscribe(
                    (result: ExternalMonitoringConfig) => {
                        this.errors = null;
    ...
    public loadExternalMonitoring() {
        this.subscriptions.add(
            this.ExternalMonitoringsService.getEdit(this.id).subscribe((result) => {
                //Fire on page load
                this.post = result;
                this.cdr.markForCheck();
                this.loadContainers();
    ...
    public submit() {
        this.subscriptions.add(
            this.ExternalMonitoringsService.edit(this.post).subscribe((result) => {
                this.cdr.markForCheck();
                if (result.success) {
    ...
    public checkConnection() {
        this.subscriptions.add(
            this.ExternalMonitoringsService.testConnection(this.post).subscribe((result: ExternalMonitoringConnect) => {
