...
import {
    VmwareEsxDirectlyWizardGet,
    VmwareEsxDirectlyWizardPost,
} from './vmware-esx-directly-wizard.interface';
...
export class VmwareEsxDirectlyComponent extends WizardsAbstractComponent {
    protected override WizardService: VmwareEsxDirectlyWizardService = inject(
        VmwareEsxDirectlyWizardService,
    );
