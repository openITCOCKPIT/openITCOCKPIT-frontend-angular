...
export interface VmwareDatastoresWizardGet extends WizardGet {
    ...
    vmwarepass: string
    vcenter: string
    datastoreServicetemplate: DatastoreServicetemplate
}
...
export interface VmwareDatastoresWizardPost extends WizardPost {
    ...
    vcenter: string
    typeId: string
    dataStoreServices: DatastoreService[];
}
...
export interface DatastoreDiscovery {
...
export interface DatastoreServicetemplate {
    id: number
    uuid: string
