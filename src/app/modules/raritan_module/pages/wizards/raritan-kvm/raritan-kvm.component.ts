...
import { RaritanKvmWizardService } from './raritan-kvm-wizard.service';
...
@Component({
    ...
    templateUrl: './raritan-kvm.component.html',
    styleUrl: './raritan-kvm.component.css',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class RaritanKvmComponent extends WizardsAbstractComponent {
    @ViewChild(WizardsDynamicfieldsComponent) childComponentLocal!: WizardsDynamicfieldsComponent;
    protected override WizardService: RaritanKvmWizardService = inject(RaritanKvmWizardService);
