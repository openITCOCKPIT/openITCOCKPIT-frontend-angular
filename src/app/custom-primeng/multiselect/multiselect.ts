                    ...
                    <ng-template #checkboxicon let-klass="class">
                        <ng-template
                            *ngTemplateOutlet="
                                ...
                                context: { checked: selected, class: klass }
                            "
                        ></ng-template>
                    </ng-template>
                </ng-container>
    ...
    template: `
        <div class="p-hidden-accessible" [attr.data-p-hidden-accessible]="true">
            <input
                ...
                [attr.aria-activedescendant]="
                    focused ? focusedOptionId : undefined
                "
            ...
            <div [ngClass]="labelClass">
                ...
                >
                    <ng-container
                        *ngTemplateOutlet="
                            $any(
                                selectedItemsTemplate || _selectedItemsTemplate
                            );
                            context: {
                                $implicit: selectedOptions,
                                removeChip: removeOption.bind(this),
                            }
                        "
                    ></ng-container>
                    <ng-container
        ...
        <ng-container *ngIf="isVisibleClearIcon">
            ...
            >
                <ng-template
                    *ngTemplateOutlet="
                        $any(clearIconTemplate || _clearIconTemplate)
                    "
                ></ng-template>
            </span>
        </ng-container>
        <div class="p-multiselect-dropdown">
            <ng-container *ngIf="loading; else elseBlock">
                <ng-container
                    *ngIf="loadingIconTemplate || _loadingIconTemplate"
                >
                    <ng-container
                        *ngTemplateOutlet="
                            $any(loadingIconTemplate || _loadingIconTemplate)
                        "
                    ></ng-container>
                </ng-container>
                <ng-container
                ...
                >
                    <span
                        *ngIf="loadingIcon"
                        [ngClass]="
                            'p-multiselect-loading-icon pi-spin ' + loadingIcon
                        "
                        aria-hidden="true"
                    ></span>
                    <span
            ...
            <ng-template #elseBlock>
                ...
                >
                    <ng-template
                        *ngTemplateOutlet="
                            $any(dropdownIconTemplate || _dropdownIconTemplate)
                        "
                    ></ng-template>
                </span>
            </ng-template>
        ...
        >
            <ng-template #content>
                ...
                >
                    ...
                    <ng-container
                        *ngTemplateOutlet="
                            $any(headerTemplate || _headerTemplate)
                        "
                    ></ng-container>
                    ...
                    >
                        <p-scroller
                            *ngIf="virtualScroll"
                            ...
                            [itemSize]="
                                $any(virtualScrollItemSize || _itemSize)
                            "
                            [autoSize]="true"
                            [tabindex]="-1"
                            [lazy]="lazy"
                        ...
                        >
                            ...
                            <ng-container
                                *ngIf="loaderTemplate || _loaderTemplate"
                            >
                                <ng-template
                                    #loader
                                    let-scrollerOptions="options"
                            ...
                            >
                                ...
                                <li
                                    *ngIf="hasFilter() && isEmpty()"
                                    ...
                                    [ngStyle]="{
                                        height: scrollerOptions.itemSize + 'px',
                                    }"
                                    role="option"
                                >
                                    @if (
                    ...
                    <div
                        *ngIf="footerFacet || footerTemplate || _footerTemplate"
                    >
                        <ng-content select="p-footer"></ng-content>
                        <ng-container
                            *ngTemplateOutlet="
                                $any(footerTemplate || _footerTemplate)
                            "
                        ></ng-container>
                    </div>
        ...
        ControlValueAccessor
{
     ...
     * @group Emits
     */
    @Output() onBlur: EventEmitter<MultiSelectBlurEvent> =
     ...
     * @group Emits
     */
    @Output() onPanelShow: EventEmitter<AnimationEvent> =
     ...
     * @group Emits
     */
    @Output() onPanelHide: EventEmitter<AnimationEvent> =
        new EventEmitter<AnimationEvent>();
    /**
    ...
    visibleOptions = computed(() => {
        ...
        const isArrayOfObjects =
            isArray(options) && ObjectUtils.isObject(options[0]);
    ...
    label = computed(() => {
        ...
        if (modelValue && modelValue.length && this.displaySelectedLabel) {
            if (
                ...
                modelValue.length > this.maxSelectedLabels
            ) {
    ...
    constructor(
        ...
        effect(() => {
            ...
            const allVisibleAndNonVisibleOptions =
                this.getAllVisibleAndNonVisibleOptions();
            if (
                allVisibleAndNonVisibleOptions &&
                isNotEmpty(allVisibleAndNonVisibleOptions)
            ) {
                if (this.optionValue && this.optionLabel && modelValue) {
                    this.selectedOptions =
                        allVisibleAndNonVisibleOptions.filter(
                            (option) =>
            ...
            if (firstCheckUp) {
                ...
                matchedOptionIndex =
                    matchedOptionIndex === -1
                        ? this.findNextSelectedOptionIndex(index)
                        : matchedOptionIndex;
            } else {
                matchedOptionIndex = this.findNextSelectedOptionIndex(index);
                matchedOptionIndex =
                    matchedOptionIndex === -1
                        ? this.findPrevSelectedOptionIndex(index)
                        : matchedOptionIndex;
            }
        }
    ...
    isSelected(option) {
        ...
        return (this.modelValue() || []).some((value) =>
            equals(value, optionValue, this.equalityKey()),
        );
    }
    ...
    getOptionIndex(index, scrollerOptions) {
        return this.virtualScrollerDisabled
            ? index
            : scrollerOptions && scrollerOptions.getItemOptions(index)['index'];
    }
    ...
    get ariaSetSize() {
        return this.visibleOptions().filter(
            (option) => !this.isOptionGroup(option),
        ).length;
    }

    getLabelByValue(value) {
        const options = this.group
            ? this.flatOptions(this._options())
            : this._options() || [];
        const matchedOption = options.find(
            (option) =>
                !this.isOptionGroup(option) &&
                equals(this.getOptionValue(option), value, this.equalityKey()),
        );
    ...
    getOptionGroupChildren(optionGroup: any) {
        return this.optionGroupChildren
            ? resolveFieldData(optionGroup, this.optionGroupChildren)
            : optionGroup.items;
    }
    ...
    onContainerClick(event: any) {
        if (
            ...
            this.loading ||
            this.readonly ||
            (event.target as Node).isSameNode(
    ...
    onToggleAll(event) {
        ...
        if (this.selectAll != null) {
            ...
            const selectedDisabledOptions =
                this.getAllVisibleAndNonVisibleOptions().filter(
                    (option) =>
            ...
            if (
                !value.length ||
                value.length === this.getAllVisibleAndNonVisibleOptions().length
            ) {
                this.onSelectAllChange.emit({
                    originalEvent: event,
        ...
        if (event.toState === 'visible') {
            ...
            if (this.options && this.options.length) {
                if (this.virtualScroll) {
                    const selectedIndex = this.modelValue()
                        ? this.focusedOptionIndex()
                        : -1;
                    if (selectedIndex !== -1) {
                    ...
                    let selectedListItem = findSingle(
                        this.itemsWrapper,
    ...
    removeOption(optionValue, event) {
        let value = this.modelValue().filter(
            (val) => !equals(val, optionValue, this.equalityKey()),
        );
