...
@Component({
    ...
    imports: [RouterLink, FaIconComponent, NavbarGroupComponent, NgClass, NavbarSearchComponent, AsyncPipe, Skeleton],
...
export class CoreuiNavbarComponent implements OnInit, OnDestroy {
    ...
    public ngOnInit() {
        ...
        this.subscriptions.add(
            this.sidebarService.sidebarState$.subscribe((next: SidebarAction) => {
    ...
    public loadMenu() {
        this.subscriptions.add(
            this.navigationService.loadMenu().subscribe((result: NavigationInterface) => {
