...
export interface HostDowntimesParams {
    ...
    'filter[DowntimeHosts.was_cancelled]': boolean,
    'filter[DowntimeHosts.was_not_cancelled]': boolean,
    'filter[Hosts.name]': '',
...
export function getDefaultHostDowntimesParams(): HostDowntimesParams {
    ...
    return {
        ...
        'filter[DowntimeHosts.author_name]': '',
        'filter[DowntimeHosts.comment_data]': '',
        'filter[DowntimeHosts.was_cancelled]': false,
        'filter[DowntimeHosts.was_not_cancelled]': false,
        'filter[Hosts.name]': '',
