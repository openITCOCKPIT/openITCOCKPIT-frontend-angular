...
import {
    getDefaultPackagesMacosUpdatesParams,
...
@Component({
    selector: 'oitc-packages-macos-updates',
    imports: [
        AsyncPipe,
    ...
    templateUrl: './packages-macos-updates.component.html',
    styleUrl: './packages-macos-updates.component.css',
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PackagesMacosUpdatesComponent implements OnInit, OnDestroy, IndexPage {
    ...
    public params: PackagesMacosUpdatesParams = getDefaultPackagesMacosUpdatesParams()
    public updates?: PackagesMacosUpdatesRoot;
    ...
    public ngOnInit(): void {
        this.subscriptions.add(this.route.queryParams.subscribe(params => {
            ...
            // //a/packages/macos?uid=161&uid=162
    ...
    public load() {
        ...
        this.subscriptions.add(
            this.PackagesService.getMacosUpdates(this.params).subscribe((response) => {
