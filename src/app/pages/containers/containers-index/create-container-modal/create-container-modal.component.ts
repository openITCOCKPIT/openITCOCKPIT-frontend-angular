    ...
    implements OnInit, OnChanges, OnDestroy
{
    ...
    public parentContainerTypeId = input<ContainerTypesEnum>(
        ContainerTypesEnum.CT_GLOBAL,
    );
    ...
    public currentContainerTypeId: ContainerTypesEnum =
        ContainerTypesEnum.CT_NODE;
    ...
    constructor() {
        effect(() => {
            this.availableContainerTypes =
                this.getOptionsForContainerTypeSelect();
    ...
    public submitLocation() {
        ...
        this.subscriptions.add(
            this.LocationsService.add(this.locationPost).subscribe((result) => {
                this.isSaving = false;
    ...
    public submitTenant() {
        this.isSaving = true;
        this.subscriptions.add(
            this.TenantsService.add(this.tenantPost).subscribe((result) => {
                this.cdr.markForCheck();
                this.isSaving = false;
    ...
    public submitNode() {
        ...
        this.subscriptions.add(
            this.ContainersService.add(this.nodePost).subscribe((result) => {
                this.isSaving = false;
                this.cdr.markForCheck();
    ...
    public getOptionsForContainerTypeSelect(): SelectKeyValue[] {
        ...
        if (this.parentContainerTypeId() === ContainerTypesEnum.CT_GLOBAL) {
            types.push({
                key: ContainerTypesEnum.CT_TENANT,
                value: this.TranslocoService.translate('Tenant'),
            });
        }

        if (this.parentContainerTypeId() !== ContainerTypesEnum.CT_GLOBAL) {
            types.push({
                key: ContainerTypesEnum.CT_NODE,
                value: this.TranslocoService.translate('Node'),
            });
            types.push({
                key: ContainerTypesEnum.CT_LOCATION,
                value: this.TranslocoService.translate('Location'),
            });
        }
        return types;
    }
