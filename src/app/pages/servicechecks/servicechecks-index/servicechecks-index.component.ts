...
export class ServicechecksIndexComponent
    implements OnInit, OnDestroy, IndexPage
{
    ...
    public params: ServicechecksIndexParams =
        getDefaultServicechecksIndexParams();
    ...
    public loadServicechecks() {
        this.params['filter[Servicechecks.state][]'] = getServiceStateForApi(
            this.stateFilter,
        );
        ...
        this.subscriptions.add(
            this.ServicechecksService.getServicechecksIndex(
                this.serviceId,
                this.params,
            ).subscribe((result) => {
                this.cdr.markForCheck();
