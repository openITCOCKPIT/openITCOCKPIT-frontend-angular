...
import {
    ...
    getDefaultBrowserSoftwareWindowsAppParams
...
export class BrowserWindowsAppsComponent implements OnDestroy {
    ...
    public params: BrowserSoftwareWindowsAppParams = getDefaultBrowserSoftwareWindowsAppParams();
    public apps?: BrowserSoftwareWindowsAppHostRoot;
    ...
    public load(): void {
        this.subscriptions.add(
            this.BrowserSoftwareService.getWindowsApps(this.hostId(), this.params).subscribe((packages) => {
                this.apps = packages;
    ...
    public resetFilter() {
        this.params = getDefaultBrowserSoftwareWindowsAppParams();
        this.load();
    }
