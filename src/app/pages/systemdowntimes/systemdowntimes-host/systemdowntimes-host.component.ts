...
export class SystemdowntimesHostComponent implements OnInit, OnDestroy {
    ...
    public params: HostSystemdowntimesParams = getDefaultHostSystemdowntimesParams();
    public hostSystemdowntimes?: SystemdowntimeHostIndexRoot;
    ...
    public loadHostSystemdowntimes() {
    ...
    public resetFilter() {
        this.params = getDefaultHostSystemdowntimesParams();
        this.loadHostSystemdowntimes();
    }
    ...
    public toggleDeleteAllModal(systemDowntime?: HostSystemdowntime) {
        let items: DeleteAllItem[] = [];
        if (systemDowntime) {
            // User just want to delete a single calendar
            items = [{
                id: systemDowntime.Systemdowntime.id,
                displayName: systemDowntime.Host.name
            }];
        } else {
