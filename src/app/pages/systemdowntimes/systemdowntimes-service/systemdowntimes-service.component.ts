...
import { getDefaultServiceSystemdowntimesParams } from '../systemdowntimes.interface';
import { DeleteAllItem } from '../../../layouts/coreui/delete-all-modal/delete-all.interface';
import { DeleteAllModalComponent } from '../../../layouts/coreui/delete-all-modal/delete-all-modal.component';


@Component({
    selector: 'oitc-systemdowntimes-service',
    standalone: true,
    imports: [
        CardComponent,
...
export class SystemdowntimesServiceComponent implements OnInit, OnDestroy {
    ...
    public params: ServiceSystemdowntimesParams = getDefaultServiceSystemdowntimesParams();
    public serviceSystemdowntimes?: SystemdowntimeServiceIndexRoot;
    ...
    public ngOnInit(): void {
        this.subscriptions.add(this.route.queryParams.subscribe(params => {
            ...
            this.loadServiceSystemdowntimes();
        }));
    }
    ...
    public loadServiceSystemdowntimes() {
        this.SelectionServiceService.deselectAll();

        this.subscriptions.add(this.SystemdowntimesService.getServiceSystemdowntimes(this.params)
            .subscribe((result) => {
                this.serviceSystemdowntimes = result;
    ...
    public resetFilter() {
        this.params = getDefaultServiceSystemdowntimesParams();
        this.loadServiceSystemdowntimes();
    }
    ...
    public toggleDeleteAllModal(systemDowntime?: ServiceSystemdowntime) {
        let items: DeleteAllItem[] = [];
        if (systemDowntime) {
            // User just want to delete a single calendar
            items = [{
                id: systemDowntime.Systemdowntime.id,
                displayName: systemDowntime.Service.servicename
            }];
        } else {
