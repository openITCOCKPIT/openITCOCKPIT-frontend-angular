...
export class DelayedPassiveServicesWidgetComponent extends BaseWidgetComponent implements AfterViewInit {
    ...
    public loadWidgetConfig() {
        ...
        this.subscriptions.add(this.DelayedPassiveServicesWidgetService.loadWidgetConfig(this.widget.id).subscribe(config => {
    ...
    public loadServices(): void {
        ...
        if (this.config.Servicestatus.delayed_greater_than !== null && this.config.Servicestatus.delayed_greater_than_unit) {
            delayed = [
                this.config.Servicestatus.delayed_greater_than, // Important, has to be array index 0 (see Filter.php)
                this.config.Servicestatus.delayed_greater_than_unit // Important, has to be array index 1 (see Filter.php)
            ];
        }
