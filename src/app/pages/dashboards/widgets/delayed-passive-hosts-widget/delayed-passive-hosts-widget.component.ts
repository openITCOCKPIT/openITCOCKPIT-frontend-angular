...
export class DelayedPassiveHostsWidgetComponent extends BaseWidgetComponent implements AfterViewInit {
    ...
    public loadWidgetConfig() {
        ...
        this.subscriptions.add(this.DelayedPassiveHostsWidgetService.loadWidgetConfig(this.widget.id).subscribe(config => {
    ...
    public loadHosts(): void {
        ...
        if (this.config.Hoststatus.delayed_greater_than !== null && this.config.Hoststatus.delayed_greater_than_unit) {
            delayed = [
                this.config.Hoststatus.delayed_greater_than, // Important, has to be array index 0 (see Filter.php)
                this.config.Hoststatus.delayed_greater_than_unit // Important, has to be array index 1 (see Filter.php)
            ];
        }
