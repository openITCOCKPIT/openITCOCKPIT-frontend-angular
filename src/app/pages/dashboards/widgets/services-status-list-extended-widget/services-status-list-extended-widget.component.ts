...
} from '../services-status-list-widget/services-status-list-widget.interface';
import { KtdGridLayout, KtdResizeEnd } from '@katoid/angular-grid-layout';
import { ServiceStatusNames } from '../../../services/services.enum';
import { MatSort, MatSortHeader, Sort } from '@angular/material/sort';
import { ServicesStatusListWidgetService } from '../services-status-list-widget/services-status-list-widget.service';
...
export class ServicesStatusListExtendedWidgetComponent extends BaseWidgetComponent implements AfterViewInit {

    // Basically this is the same widget as the ServicesStatusListWidgetComponent, but with a modal to show more details
    ...
    public toggleServiceBrowserModal(serviceId: number | undefined) {
        if (serviceId) {
