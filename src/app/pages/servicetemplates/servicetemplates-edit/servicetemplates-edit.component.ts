...
export class ServicetemplatesEditComponent implements OnInit, OnDestroy {
    ...
    public loadContainers(servicetemplateId: number) {
        this.subscriptions.add(
            this.ServicetemplatesService.loadContainers(servicetemplateId).subscribe((result) => {
    ...
    private loadCommandArguments() {
        ...
        this.subscriptions.add(
            this.ServicetemplatesService.loadCommandArguments(commandId, servicetemplateId).subscribe((result) => {
